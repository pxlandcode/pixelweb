<script lang="ts">
        import { Button, Card, Tab, TabHandler } from '@pixelcode_/blocks/components';
...
<div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
                <Button variant="secondary" onclick={() => (showEditor = !showEditor)}>
...
<div class="mt-6 space-y-4">
        ...
        <Tab.View active={tabHandler.activeView === 0} class="flex gap-4 items-start">
